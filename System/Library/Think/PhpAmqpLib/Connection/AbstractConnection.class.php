<?php
namespace Think\PhpAmqpLib\Connection;

use Think\PhpAmqpLib\Channel\AMQPChannel;
use Think\PhpAmqpLib\Channel\AbstractChannel;
use Think\PhpAmqpLib\Exception\AMQPProtocolConnectionException;
use Think\PhpAmqpLib\Exception\AMQPRuntimeException;
use Think\PhpAmqpLib\Exception\AMQPTimeoutException;
use Think\PhpAmqpLib\Wire\AMQPReader;
use Think\PhpAmqpLib\Wire\AMQPTable;
use Think\PhpAmqpLib\Wire\AMQPWriter;
use Think\PhpAmqpLib\Wire\IO\AbstractIO;
use Think\PhpAmqpLib\Wire\IO\SocketIO;
use Think\PhpAmqpLib\Wire\IO\StreamIO;
...
class AbstractConnection extends AbstractChannel
{
    ...
    /** @var \Think\PhpAmqpLib\Wire\IO\AbstractIO */
    protected $io;
     ...
     * @return array
     * @throws \Exception
     * @throws \Think\PhpAmqpLib\Exception\AMQPTimeoutException
     * @throws \Think\PhpAmqpLib\Exception\AMQPRuntimeException
     */
     ...
     * @throws \Think\PhpAmqpLib\Exception\AMQPProtocolConnectionException
     */
    ...
    /**
     * @return \Think\PhpAmqpLib\Wire\IO\AbstractIO
     */
