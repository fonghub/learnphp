<?php
namespace Think\PhpAmqpLib\Channel;

use Think\PhpAmqpLib\Connection\AbstractConnection;
use Think\PhpAmqpLib\Exception\AMQPOutOfBoundsException;
use Think\PhpAmqpLib\Exception\AMQPOutOfRangeException;
use Think\PhpAmqpLib\Exception\AMQPRuntimeException;
use Think\PhpAmqpLib\Helper\DebugHelper;
use Think\PhpAmqpLib\Helper\Protocol\MethodMap080;
use Think\PhpAmqpLib\Helper\Protocol\MethodMap091;
use Think\PhpAmqpLib\Helper\Protocol\Protocol080;
use Think\PhpAmqpLib\Helper\Protocol\Protocol091;
use Think\PhpAmqpLib\Helper\Protocol\Wait080;
use Think\PhpAmqpLib\Helper\Protocol\Wait091;
use Think\PhpAmqpLib\Message\AMQPMessage;
use Think\PhpAmqpLib\Wire\AMQPReader;
...
abstract class AbstractChannel
{
    ...
    /** @var \Think\PhpAmqpLib\Helper\DebugHelper */
    protected $debug;

    /** @var \Think\PhpAmqpLib\Connection\AbstractConnection */
    ...
    /** @var \Think\PhpAmqpLib\Helper\Protocol\Protocol080|\Think\PhpAmqpLib\Helper\Protocol\Protocol091 */
    protected $protocolWriter;

    /** @var \Think\PhpAmqpLib\Helper\Protocol\Wait080|\Think\PhpAmqpLib\Helper\Protocol\Wait091 */
    protected $waitHelper;

    /** @var \Think\PhpAmqpLib\Helper\Protocol\MethodMap080|\Think\PhpAmqpLib\Helper\Protocol\MethodMap091 */
    protected $methodMap;

    /** @var string */
    protected $channel_id;

    /** @var \Think\PhpAmqpLib\Wire\AMQPReader */
     ...
     * @throws \Think\PhpAmqpLib\Exception\AMQPRuntimeException
     */
    public function __construct(AbstractConnection $connection, $channel_id)
    {
        ...
        switch ($this->protocolVersion) {
            case self::PROTOCOL_091:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Think\PhpAmqpLib\Wire\Constants091';
            ...
            case self::PROTOCOL_080:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Think\PhpAmqpLib\Wire\Constants080';
                $c = self::$PROTOCOL_CONSTANTS_CLASS;
                $this->debug = new DebugHelper($c);
                $this->amqp_protocol_header = $c::$AMQP_PROTOCOL_HEADER;
     ...
     * @param \Think\PhpAmqpLib\Wire\AMQPWriter|string $args
     */
     ...
     * @param array $method_sig
     * @param \Think\PhpAmqpLib\Wire\AMQPWriter|string $args
     * @param \Think\PhpAmqpLib\Wire\AMQPWriter $pkt
     * @return \Think\PhpAmqpLib\Wire\AMQPWriter
     */
     ...
     * @return \Think\PhpAmqpLib\Message\AMQPMessage
     */
     ...
     * @param int $timeout
     * @throws \Think\PhpAmqpLib\Exception\AMQPOutOfBoundsException
     * @throws \Think\PhpAmqpLib\Exception\AMQPRuntimeException
     * @return mixed
     */
