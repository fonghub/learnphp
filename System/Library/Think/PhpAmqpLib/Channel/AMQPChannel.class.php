...
use Think\PhpAmqpLib\Exception\AMQPBasicCancelException;
use Think\PhpAmqpLib\Exception\AMQPProtocolChannelException;
...
class AMQPChannel extends AbstractChannel
{
    ...
    /**
     * @param \Think\PhpAmqpLib\Connection\AbstractConnection $connection
    ...
    /**
     * @param AMQPReader $reader
     * @throws \Think\PhpAmqpLib\Exception\AMQPProtocolChannelException
     */
    ...
    /**
     * @param AMQPReader $reader
     * @throws \Think\PhpAmqpLib\Exception\AMQPBasicCancelException
     */
