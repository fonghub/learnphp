<?php
namespace Think\PhpAmqpLib\Wire;

use Think\PhpAmqpLib\Exception\AMQPInvalidArgumentException;
...
use Think\PhpAmqpLib\Exception\AMQPIOWaitException;
use Think\PhpAmqpLib\Helper\MiscHelper;
...
class AMQPReader extends AbstractClient
{
     ...
     *
     * @throws \Think\PhpAmqpLib\Exception\AMQPIOWaitException
